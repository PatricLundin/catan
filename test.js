...
const nodePosFromVals = o => {
  return nodeIdxToNodePos.findIndex(n => n.x === o.x && n.y === o.y);
};

roadToNodes.forEach(nodes => {
  console.log(`[${nodePosFromVals(nodes[0])}, ${nodePosFromVals(nodes[1])}],`);
});
